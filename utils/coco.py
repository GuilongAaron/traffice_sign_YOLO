...
class COCO(Dataset):
    def __init__(self, data_dir, image_size=(608, 608), mosaic=True):
        ...
        self.annot_path = os.path.join(self.data_dir, "annotations", 'annotations_TT100K_coco_formatted_train.json')
...
class COCOEval(COCO):
    def __init__(self, data_dir, image_size=(416, 416)):
        ...
        self.data_dir = data_dir
        self.annot_path = os.path.join(self.data_dir, "annotations", 'annotations_TT100K_coco_formatted_test.json')
